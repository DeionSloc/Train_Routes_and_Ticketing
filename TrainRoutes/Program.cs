...
var ticket1 = new Ticket("Virginia Beach, VA", "New York, NY", "Coach");
var ticket2 = new Ticket("Raleigh, NC", "Yonkers, NY", "Coach");
...
Console.WriteLine(ticket1.travelClass["Coach"]);
